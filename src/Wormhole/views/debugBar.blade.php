    ...
    <div id="wormholeBottomBarHeader">
        ...
        <div id="wormholeBottomBarHeaderRight">
            <div class="wormholeBottomBarHeaderRightParts">
                ...
                <p>{{ (isset($env['constellation']['main']['request_type'])) ?
                $env['constellation']['main']['request_type'] : $_SERVER['REQUEST_METHOD'] }} <span id="debugRoute">{{ (isset
                ($env['constellation']['main']['request_string'])) ? $env['constellation']['main']['request_string'] : '' }}</span></p>
